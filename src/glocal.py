# -*- coding: utf-8 -*-
"""
Created on Tue Sep 13 11:09:30 2022
...
def glocal(fasta1, fasta2, prot_name1, prot_name2, alignment_matrix):
    """Performs a glocal alignment following.
    ...
    """
    # strating_position corresponds to the maximum score in the last column.
    ...
    while max_number >= 1:
        ...
        with open (f'../results/Glocal_{prot_name1}_&_{prot_name2}.txt', "a") as file:
            file.write(
